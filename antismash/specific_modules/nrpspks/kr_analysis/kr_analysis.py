...
def run_kr_analysis(infile2, out_file):
    ...
    for i in namesb:
        ...
        refsequence = (
            "MAPSI|PKS|CAM00062.1|Erythromycin_synthase_modules_1_and_2|Sacc_KR1"
        )
        namesa = [i]
    ...
    for i in querysignames:
        ...
        if (
            ...
            and (
                querysigseq_act[1] == "S"
                or querysigseq_act[1] == "A"
                or querysigseq_act[1] == "G"
            )
            and querysigseq_act[2] == "Y"
            and querysigseq_act[3] == "N"
        ):
            activity = "active"
        if (
            querysigseq_act[0] == "E"
            ...
            and querysigseq_act[2] == "H"
            and querysigseq_act[3] == "H"
        ):
            activity = "active"
        if (
            querysigseq_act[0] == "K"
            ...
            and querysigseq_act[2] == "Y"
            and (querysigseq_act[3] == "N" or querysigseq_act[3] == "G")
        ):
            activity = "active"
    ...
    for i in querysignames:
        ...
        if (
            querysigseq_ste[0:3] != "LDD"
            and querysigseq_ste[3] == "W"
            and querysigseq_ste[4] != "H"
            and querysigseq_ste[5:] == "YAN"
        ):
            stereochemistry = "A1"
            ...
            querysigseq_ste[0:3] == "LDD"
            and querysigseq_ste[5] == "Y"
            and querysigseq_ste[6] != "P"
            and querysigseq_ste[7] == "N"
        ):
            stereochemistry = "B1"
