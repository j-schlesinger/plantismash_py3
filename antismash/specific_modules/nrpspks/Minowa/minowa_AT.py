...
def run_minowa_at(infile2, outfile):
    ...
    for i in namesb:
        ...
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "2-Methylbutyryl-CoA.hmm")
        )
        ...
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Acetyl-CoA.hmm")
        )
        hmmname = "Acetyl-CoA"
        hmm_names.append(hmmname)
        hmmscore = hmmscores(hmmresults)
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "CHC-CoA.hmm")
        )
        hmmname = "CHC-CoA"
        hmm_names.append(hmmname)
        hmmscore = hmmscores(hmmresults)
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "fatty_acid.hmm")
        )
        hmmname = "fatty_acid"
        hmm_names.append(hmmname)
        hmmscore = hmmscores(hmmresults)
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Isobutyryl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Methoxymalonyl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Propionyl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "3-Methylbutyryl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Benzoyl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Ethylmalonyl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "inactive.hmm")
        )
        hmmname = "inactive"
        hmm_names.append(hmmname)
        hmmscore = hmmscores(hmmresults)
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Malonyl-CoA.hmm")
        )
        hmmname = "Malonyl-CoA"
        hmm_names.append(hmmname)
        hmmscore = hmmscores(hmmresults)
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "Methylmalonyl-CoA.hmm")
        )
        ...
        hmm_scores.append(hmmscore[0])
        hmmresults = hmmsearch(
            "hmm_infile.fasta", path.join(at_hmms_dir, "trans-1,2-CPDA.hmm")
        )
