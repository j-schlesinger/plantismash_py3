...
def check_glutamine_aromat_structure(feat):
    ...
    feat.qualifiers["glutamine_aromat_structures"] = [
        glutamine_seqs
    ] + check_for_aromatic_structure(glutamine_seqs)
...
def check_instances_aromat_structure(feat):
    ...
    feat.qualifiers["instances_aromat_structures"] = check_for_aromatic_structure(
        instances
    )
