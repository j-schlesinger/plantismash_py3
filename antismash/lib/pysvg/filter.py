...
class feComponentTransfer(
    BaseElement, CoreAttrib, FilterColorAttrib, FilterPrimitiveWithInAttrib
):
    """
...
class feComposite(feComponentTransfer):
    ...
    def __init__(
        self, in2=None, operator=None, k1=None, k2=None, k3=None, k4=None, **kwargs
    ):
...
class feDiffuseLighting(
    ...
    def __init__(
        self, surfaceScale=None, diffuseConstant=None, kernelUnitLength=None, **kwargs
    ):
...
class feFlood(
    feComponentTransfer, StyleAttrib, PaintAttrib, PresentationAttributes_feFlood
):
    """
