...
class rect(BaseShape, PointAttrib, DimensionAttrib):
    ...
    def __init__(
        self, x=None, y=None, width=None, height=None, rx=None, ry=None, **kwargs
    ):
    ...
    def getEdgePoints(self):
        ...
        result.append(
            (float(self.get_x()) + float(self.get_width()), float(self.get_y()))
        )
        result.append(
            (
                float(self.get_x()) + float(self.get_width()),
                float(self.get_y()) + float(self.get_height()),
            )
        )
        result.append(
            (float(self.get_x()), float(self.get_y()) + float(self.get_height()))
        )
        return result
    ...
    def getInnerEdgePoints(self):
        ...
        result.append(
            (
                float(self.get_x()) + float(self.get_rx()),
                float(self.get_y()) + float(self.get_ry()),
            )
        )
        result.append(
            (
                float(self.get_x()) + float(self.get_width()) - float(self.get_rx()),
                float(self.get_y()) + float(self.get_ry()),
            )
        )
        result.append(
            (
                float(self.get_x()) + float(self.get_width()) - float(self.get_rx()),
                float(self.get_y()) + float(self.get_height()) - float(self.get_ry()),
            )
        )
        result.append(
            (
...
class circle(BaseShape):
    ...
    def getBottomLeft(self):
        ...
        """
        return (
            float(self.get_cx()) - float(self.get_r()),
            float(self.get_cy()) - float(self.get_r()),
        )
...
class ellipse(BaseShape):
    ...
    def getBottomLeft(self):
        ...
        """
        return (
            float(self.get_cx()) - float(self.get_rx()),
            float(self.get_cy()) - float(self.get_ry()),
        )
...
class path(BaseShape, ExternalAttrib, MarkerAttrib):
    ...
    def __init__(
        self, pathData="", pathLength=None, style=None, focusable=None, **kwargs
    ):
    ...
    def appendCubicCurveToPath(
        ...
        self.__append__(
            "c",
            [controlstartx, controlstarty, controlendx, controlendy, endx, endy],
            relative,
        )

    def appendCubicShorthandCurveToPath(
        self, controlendx, controlendy, endx, endy, relative=True
    ):
    ...
    def appendArcToPath(
        ...
        self.__append__(
            "a", [rx, ry, x_axis_rotation, large_arc_flag, sweep_flag, x, y], relative
        )
