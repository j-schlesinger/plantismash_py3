...
def create_svgs(options, seq_record):
    ...
    if options.clusterblast:
        seq_record.clusterblastpositiondata = create_clusterblast_svg(
            options, seq_record, screenwidth
        )
    if options.subclusterblast:
        seq_record.subclusterblastpositiondata = create_clusterblast_svg(
            options, seq_record, screenwidth, searchtype="subclusters"
        )
    if options.knownclusterblast:
        seq_record.knownclusterblastpositiondata = create_clusterblast_svg(
            options, seq_record, screenwidth, searchtype="knownclusters"
        )
...
def create_genecluster_svg(options, seq_record, screenwidth):
    ...
    for genecluster in geneclusters:
        ...
        outfile = open(
            options.svgdir + os.sep + "genecluster" + str(qclusternr) + ".svg", "w"
        )
...
def _gene_arrow(start, end, strand, color, base, height):
    ...
    pg = oh.createPolygon(
        points=oh.convertTupleArrayToPoints(pointsAsTuples),
        strokewidth=1,
        stroke="black",
        fill=color,
    )
...
def domains_svg_part(
    s, geneposdict, pksnrpsprots, pksnrpsdomains, qclusternr, screenwidth
):
    ...
    for i in pksnrpsprots:
        ...
        group.addElement(
            oh.createLine(
                10,
                (z * 60),
                10 + ((float(protlength) / float(longestprot)) * (screenwidth * 0.75)),
                (z * 60),
                strokewidth=1,
                stroke="grey",
            )
        ...
        for j in domains:
            ...
            if "PKS_KS" in j:
                c = LinearGradient(
                    "#08B208",
                    "#81F781",
                    "KS_domain" + str(qclusternr) + "_" + str(ksnr),
                )
                d = LinearGradient(
                    "#81F781", "#08B208", "KS_line" + str(qclusternr) + "_" + str(ksnr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    str((endpos - startpos) / aa2pixelratio),
                    15,
                    8,
                    strokewidth=1,
                    stroke="url(#KS_line" + str(qclusternr) + "_" + str(ksnr) + ")",
                    fill="url(#KS_domain" + str(qclusternr) + "_" + str(ksnr) + ")",
                )
                f = text(
                    "KS",
                    (
                        (-4 + startpos / aa2pixelratio)
                        + 0.5 * ((endpos - startpos) / aa2pixelratio)
                    ),
                    ((z * 60) + 4),
                    fill="#0A2A0A",
                )
                if ((endpos - startpos) / aa2pixelratio) < 100 and (
                    (endpos - startpos) / aa2pixelratio
                ) >= 20:
                    myStyle.setFontSize("8px")
                    f = text(
                        "KS",
                        (
                            (startpos / aa2pixelratio)
                            + 0.5 * ((endpos - startpos) / aa2pixelratio)
                        ),
                        ((z * 60) + 3),
                        fill="#3B0B0B",
                ...
                c = LinearGradient(
                    "#DC0404",
                    "#F78181",
                    "AT_domain" + str(qclusternr) + "_" + str(atnr),
                )
                d = LinearGradient(
                    "#F78181", "#DC0404", "AT_line" + str(qclusternr) + "_" + str(atnr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#AT_line" + str(qclusternr) + "_" + str(atnr) + ")",
                    fill="url(#AT_domain" + str(qclusternr) + "_" + str(atnr) + ")",
                )
                f = text(
                    "AT",
                    (
                ...
                c = LinearGradient(
                    "#B45F04",
                    "#F7BE81",
                    "DH_domain" + str(qclusternr) + "_" + str(dhnr),
                )
                d = LinearGradient(
                    "#F7BE81", "#B45F04", "DH_line" + str(qclusternr) + "_" + str(dhnr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#DH_line" + str(qclusternr) + "_" + str(dhnr) + ")",
                    fill="url(#DH_domain" + str(qclusternr) + "_" + str(dhnr) + ")",
                )
                f = text(
                    "DH",
                    (
                ...
                c = LinearGradient(
                    "#089E4B",
                    "#81F781",
                    "KR_domain" + str(qclusternr) + "_" + str(krnr),
                )
                d = LinearGradient(
                    "#81F781", "#089E4B", "KR_line" + str(qclusternr) + "_" + str(krnr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#KR_line" + str(qclusternr) + "_" + str(krnr) + ")",
                    fill="url(#KR_domain" + str(qclusternr) + "_" + str(krnr) + ")",
                )
                f = text(
                    "KR",
                    (
                ...
                c = LinearGradient(
                    "#089E85",
                    "#81F7F3",
                    "ER_domain" + str(qclusternr) + "_" + str(ernr),
                )
                d = LinearGradient(
                    "#81F7F3", "#089E85", "ER_line" + str(qclusternr) + "_" + str(ernr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#ER_line" + str(qclusternr) + "_" + str(ernr) + ")",
                    fill="url(#ER_domain" + str(qclusternr) + "_" + str(ernr) + ")",
                )
                f = text(
                    "ER",
                    (
                ...
                c = LinearGradient(
                    "#084BC6",
                    "#81BEF7",
                    "ACP_domain" + str(qclusternr) + "_" + str(acpnr),
                )
                d = LinearGradient(
                    "#81BEF7",
                    "#084BC6",
                    "ACP_line" + str(qclusternr) + "_" + str(acpnr),
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#ACP_line" + str(qclusternr) + "_" + str(acpnr) + ")",
                    fill="url(#ACP_domain" + str(qclusternr) + "_" + str(acpnr) + ")",
                )
                f = text(
                    "ACP",
                    (
                ...
                ("C" in j or "Heterocyclization" in j)
                and "ACP" not in j
                and "PCP" not in j
                and "NRPS-COM" not in j
                and "CAL" not in j
                and "cMT" not in j
            ):
                c = LinearGradient(
                    "#393989", "#8181F7", "C_domain" + str(qclusternr) + "_" + str(cnr)
                )
                d = LinearGradient(
                    "#8181F7", "#393989", "C_line" + str(qclusternr) + "_" + str(cnr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#C_line" + str(qclusternr) + "_" + str(cnr) + ")",
                    fill="url(#C_domain" + str(qclusternr) + "_" + str(cnr) + ")",
                )
                f = text(
                    "C",
                    (
                ...
                c = LinearGradient(
                    "#393989", "#8181F7", "E_domain" + str(qclusternr) + "_" + str(enr)
                )
                d = LinearGradient(
                    "#8181F7", "#393989", "E_line" + str(qclusternr) + "_" + str(enr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#E_line" + str(qclusternr) + "_" + str(enr) + ")",
                    fill="url(#E_domain" + str(qclusternr) + "_" + str(enr) + ")",
                )
                f = text(
                    "E",
                    (
                ...
                c = LinearGradient(
                    "#56157F", "#BE81F7", "A_domain" + str(qclusternr) + "_" + str(anr)
                )
                d = LinearGradient(
                    "#BE81F7", "#56157F", "A_line" + str(qclusternr) + "_" + str(anr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#A_line" + str(qclusternr) + "_" + str(anr) + ")",
                    fill="url(#A_domain" + str(qclusternr) + "_" + str(anr) + ")",
                )
                f = text(
                    "A",
                    (
                ...
                c = LinearGradient(
                    "#084BC6",
                    "#81BEF7",
                    "PCP_domain" + str(qclusternr) + "_" + str(pcpnr),
                )
                d = LinearGradient(
                    "#81BEF7",
                    "#084BC6",
                    "PCP_line" + str(qclusternr) + "_" + str(pcpnr),
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#PCP_line" + str(qclusternr) + "_" + str(pcpnr) + ")",
                    fill="url(#PCP_domain" + str(qclusternr) + "_" + str(pcpnr) + ")",
                )
                f = text(
                    "PCP",
                    (
                ...
                c = LinearGradient(
                    "#750072",
                    "#F5A9F2",
                    "TE_domain" + str(qclusternr) + "_" + str(tenr),
                )
                d = LinearGradient(
                    "#F5A9F2", "#750072", "TE_line" + str(qclusternr) + "_" + str(tenr)
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#TE_line" + str(qclusternr) + "_" + str(tenr) + ")",
                    fill="url(#TE_domain" + str(qclusternr) + "_" + str(tenr) + ")",
                )
                ...
                c = LinearGradient(
                    "#929292",
                    "#DBDBDB",
                    "other_domain" + str(qclusternr) + "_" + str(othernr),
                )
                d = LinearGradient(
                    "#DBDBDB",
                    "#929292",
                    "other_line" + str(qclusternr) + "_" + str(othernr),
                )
                e = oh.createRect(
                    str(10 + startpos / aa2pixelratio),
                    str((z * 60) - 8),
                    ...
                    8,
                    strokewidth=1,
                    stroke="url(#other_line"
                    + str(qclusternr)
                    + "_"
                    + str(othernr)
                    + ")",
                    fill="url(#other_domain"
                    + str(qclusternr)
                    + "_"
                    + str(othernr)
                    + ")",
...
def relativepositions(starts, ends, largestclustersize, screenwidth):
    ...
    for i in starts:
        i = float(float(int(i) - int(leftboundary)) / largestclustersize) * float(
            screenwidth * 0.75
        )
        i = int(i)
        rel_starts.append(i)
...
def geneclustersvg(
    ...
    group.addElement(
        oh.createLine(
            10, 60, 10 + (screenwidth * 0.75), 60, strokewidth=2, stroke="grey"
        )
    )
    s.addElement(group)
    # Add gene arrows
    ...
    for x in range(nrgenes):
        ...
        group.addElement(
            _gene_arrow(
                10 + rel_starts[a], 10 + rel_ends[a], strands[a], colors[a], 65, 10
            )
        )
...
def create_clusterblast_svg(options, seq_record, screenwidth, searchtype="general"):
    ...
    for genecluster in geneclusters:
        ...
        colorschemedict, rgbcolorscheme = calculate_colorgroups(
            qclusternr,
            hitclusters,
            queryclusterdata,
            seq_record.internalhomologygroupsdict,
        )
        for k in hitclusters:
            cresults = clusterblastresults(
                options,
                qclusternr,
                [k],
                queryclusterdata,
        ...
        if s is not None:
            ...
            outfile = open(
                options.svgdir + os.sep + file_id + str(qclusternr) + "_all.svg", "w"
            )
            outfile.write(s.getXML())
            outfile.close()
        idx += 1
...
def clusterblastresults(
    ...
    strandsbalancedict = findstrandsbalance(
        hitclusternumbers,
        hitclusterdata,
        queryclustergenes,
    ...
    qstarts, qends, qstrands, qcolors, qnrgenes, hdata = generate_genecoords(
        strandsbalancedict,
        queryclustergenes,
        queryclustergenesdetails,
        colorschemedict,
    ...
    largestclustersize, smallestclustersize, qclustersize = findclustersizes(
        options, hitclusternumbers, hdata, qstarts, qends
    )
    ...
    hdata, qdata = align_geneclusters(
        options,
        hitclusternumbers,
        hdata,
        qdata,
...
def calculate_colorgroups(
    queryclusternumber, hitclusternumbers, queryclusterdata, internalhomologygroupsdict
):
    # Extract data and generate color scheme
    nrhitclusters = queryclusterdata[queryclusternumber][0]
    hitclusterdata = queryclusterdata[queryclusternumber][1]
        ...
        for i in queryclustergenes:
            ...
            for j in colorgroupsdict[m]:
                if i in j:
                    for k in j:
                        if (
                            k in hitclusterdata[m][1]
                            and hitclustergenesdetails[k][2] == refstrand
                        ):
                            strandsbalance += 1
                        elif (
                            k in hitclusterdata[m][1]
                            and hitclusterdata[m][2][k][2] != refstrand
                        ):
...
def findclustersizes(options, hitclusternumbers, hdata, qstarts, qends):
    ...
    if options.homologyscalelimit > 1.0:
        largestclustersize = min(
            largestclustersize, options.homologyscalelimit * qclustersize
        )
    smallestclustersize = min(clustersizes)
    return largestclustersize, smallestclustersize, qclustersize


def align_geneclusters(
    options,
    hitclusternumbers,
    hdata,
    qdata,
    ...
    for m in hitclusternumbers:
        hclustersize = abs(int(hdata[m][1][-1]) - int(hdata[m][0][0]))
        hrelpositions = relativepositions(
            hdata[m][0], hdata[m][1], largestclustersize, screenwidth
        )
        ...
        if (
            ...
            for i in qrel_starts:
                qrel_starts2.append(
                    ...
                    + int(
                        float(
                            float(float(largestclustersize - qclustersize) / 2.0)
                            / largestclustersize
                        )
                        * float(screenwidth * 0.75)
                    )
                )
            for i in qrel_ends:
                qrel_ends2.append(
            ...
            for i in hrel_starts:
                hrel_starts2.append(
                    ...
                    + int(
                        float(
                            float(float(largestclustersize - hclustersize) / 2.0)
                            / largestclustersize
                        )
                        * float(screenwidth * 0.75)
                    )
...
def clusterblast_gene_arrows(
    ...
    group.addElement(
        oh.createLine(
            10, 35, 10 + (screenwidth * 0.75), 35, strokewidth=1, stroke="grey"
        )
    )
    ...
    for x in range(qnrgenes):
        ...
        if len(hitclusternumbers) == 1:
            arrow.set_id(
                "%s-%s_q%s_%s_%s"
                % (file_id, idx, queryclusternumber, hitclusternumbers[0], x)
            )
        else:
        ...
        arrow.setAttribute(
            "description", "%s[br]Location: %s - %s" % (desc, start, end)
        )
    ...
    for m in hitclusternumbers:
        ...
        if hitcluster_acc.startswith("BGC"):
            acc = text(
                '<a xlink:href="http://mibig.secondarymetabolites.org/repository/'
                + hitcluster_acc.partition("_c")[0]
                + '/index.html" target="_blank">'
                + hitcluster_acc
                + "</a>: "
                + hitcluster_desc,
                5,
                20 + 50 * (hitclusternumbers.index(m) + 1),
            )
        else:
            acc = text(
                hitcluster_acc + ": " + hitcluster_desc,
                5,
                20 + 50 * (hitclusternumbers.index(m) + 1),
            )
        acc.set_class("clusterblast-acc")
        ...
        group.addElement(
            oh.createLine(
                10,
                35 + 50 * (hitclusternumbers.index(m) + 1),
                10 + (screenwidth * 0.75),
                35 + 50 * (hitclusternumbers.index(m) + 1),
                strokewidth=1,
                stroke="grey",
        ...
        for x in range(hnrgenes):
            ...
            if hcolors[a] == "white":
                arrow = _gene_arrow(
                    ...
                    hstrands[a],
                    rgbcolorscheme[-1],
                    40 + 50 * (hitclusternumbers.index(m) + 1),
                    10,
                )
            else:
                arrow = _gene_arrow(
                    ...
                    10 + hrel_ends[a],
                    hstrands[a],
                    rgbcolorscheme[hcolors[a]],
                    40 + 50 * (hitclusternumbers.index(m) + 1),
                    10,
                )
            if len(hitclusternumbers) == 1:
                arrow.set_id(
                    "%s-%s_h%s_%s_%s" % (file_id, idx, queryclusternumber, m, x)
                )
            else:
                arrow.set_id(
                    "%s-%s_all_%s_%s_%s" % (file_id, idx, queryclusternumber, m, x)
                )

            arrow.setAttribute("locus_tag", hitclustergenes[x])
            start, end, strand, desc, hitgene_acc = hitclustergenesdetails[
                hitclustergenes[x]
            ]
            ...
            if hitclustergenes[x] in hits_accessions_dict:
                ...
                for querygene in querygenes:
                    evalue, bitscore, pid, pcov = blastdetailsdict[
                        querygene + "_|_|_" + hitclustergenes[x]
                    ]
                    ...
                    description_string += (
                        "<br><br><b>BlastP hit with %s</b><br>Percentage identity: %s<br>Percentage coverage: %s<br>BLAST bit score: %s<br>E-value: %s"
                        % (querygene, pid, pcov, bitscore, evalue)
                    )
