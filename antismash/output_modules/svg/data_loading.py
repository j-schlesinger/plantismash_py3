        ...
        if seq_record.id in options.extrarecord:
            ...
            for key in list(options.extrarecord[seq_record.id].extradata.keys()):
                if key == "ClusterBlastData":
                    ...
                    clusterBlastResults = options.extrarecord[seq_record.id].extradata[
                        key
                    ]
                    ...
                    seq_record.known_compound_dict = (
                        clusterBlastResults.known_compound_dict
                    )
                    ...
                    seq_record.internalhomologygroupsdict = (
                        subclusterBlastResults.internalhomologygroupsdict
                    )
                    seq_record.sc_nrhitgeneclusters = (
                        subclusterBlastResults.sc_nrhitgeneclusters
                    )
                    #        seq_record.sc_qgeneclusterdata = subclusterBlastResults.sc_qgeneclusterdata
                    seq_record.sc_queryclusterdata = (
                        subclusterBlastResults.sc_queryclusterdata
                    )
                    ...
                    seq_record.internalhomologygroupsdict = (
                        knownclusterBlastResults.internalhomologygroupsdict
                    )
                    seq_record.kc_nrhitgeneclusters = (
                        knownclusterBlastResults.kc_nrhitgeneclusters
                    )
                    #        seq_record.kc_qgeneclusterdata = knownclusterBlastResults.sc_qgeneclusterdata
                    seq_record.kc_queryclusterdata = (
                        knownclusterBlastResults.kc_queryclusterdata
                    )
